...
class AddTodoPage extends StatefulWidget {
  ...
  const AddTodoPage({super.key, this.initialListId});
...
class _AddTodoPageState extends State<AddTodoPage> {
  ...
  String _category = 'Others'; // Work, Personal, Education, Shopping, Others
  DateTime? _dueDate;
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 14,
                            color: _dueDate == null ? inkMuted : inkColor,
                          ),
                        ),
                      ),
                    ),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formkey.currentState!.validate()) {
                      ...
                      context.read<TaskBloc>().add(AddTaskEvent(todo));

                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('task_added_success'.tr)),
                      );
